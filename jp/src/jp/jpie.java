...
//	    System.out.println(a.getText());
	  ...
	  @Test
	  public void testjpie() throws Exception {
...
//	    Thread.sleep(500);
	    ...
	    wait.until(ExpectedConditions.textToBePresentInElementValue(By.cssSelector("#PWCMasterPage_ctrlWUCSiteMenu_rptMenuContent_ctl04_rptSubMenu_ctl01_lbParentItem > span"),"Select"));
	    System.out.println("3");
	    ...
	    wait.until(ExpectedConditions.textToBePresentInElementValue(By.id("PWCMasterPage_PWCWebPartManager_gwpQuoteFrUc_QuoteFrUc_ddlProduct"), "Air Freight"));
	    ...
	    wait.until(ExpectedConditions.textToBePresentInElementValue(By.id("PWCMasterPage_PWCWebPartManager_gwpQuoteFrUc_QuoteFrUc_ddlProductType"), "Value"));
	    System.out.println("4");
	    ...
	    wait.until(ExpectedConditions.textToBePresentInElementValue(By.id("PWCMasterPage_PWCWebPartManager_gwpQuoteFrUc_QuoteFrUc_ddlMovementType"), "Airport to Airport"));
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(By.id("PWCMasterPage_PWCWebPartManager_gwpQuoteFrUc_QuoteFrUc_txtCustomerName_btnPopup")));
	    driver.findElement(By.id("PWCMasterPage_PWCWebPartManager_gwpQuoteFrUc_QuoteFrUc_txtCustomerName_btnPopup")).click();
	    wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[@id='refresh_pnlPopupGrid']/div/span")));
