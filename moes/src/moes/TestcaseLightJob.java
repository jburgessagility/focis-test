...
public class TestcaseLightJob {
  ...
  @Test
  public void testCaseLightJob(WebDriver driver) throws Exception {
//	  public void testCaseLightJob() throws Exception {
    ...
    break;
	}catch(org.openqa.selenium.UnhandledAlertException | org.openqa.selenium.NoSuchElementException | org.openqa.selenium.TimeoutException | org.openqa.selenium.StaleElementReferenceException | org.openqa.selenium.remote.UnreachableBrowserException e ){System.out.println("err light job");driver.get(moes.bburl);
	driver.get(s);}
	}
