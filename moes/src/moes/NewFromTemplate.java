...
public class NewFromTemplate {
  ...
  @Test
  public void testNewFromTemplate(WebDriver driver) throws Exception {
...
//	  public void testNewFromTemplate() throws Exception {
    ...
    break;
			}catch(org.openqa.selenium.remote.UnreachableBrowserException | org.openqa.selenium.UnhandledAlertException | org.openqa.selenium.NoSuchElementException | org.openqa.selenium.TimeoutException | org.openqa.selenium.StaleElementReferenceException  e ){System.out.println("err nft");driver.get(moes.bburl);
			driver.get(s);}}
  }
